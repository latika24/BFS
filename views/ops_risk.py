...
with h1_:
    ...
    st.plotly_chart(light(figh), use_container_width=True,
                    theme=None)
...
with l1:
    ...
    st.plotly_chart(light(figl), use_container_width=True,
                    theme=None)
...
st.plotly_chart(light(figa), use_container_width=True,
                    theme=None)
